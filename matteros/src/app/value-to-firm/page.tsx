...
export default function ValueToFirmPage() {
      ...
      <main className="value-shell">
        <section className="value-hero">
          ...
          <h1>
            ...
            helps immigration firms make explainable decisions faster, with less malpractice exposure
            and less partner firefighting.
          </h1>
        </section>
        ...
        <section className="value-section">
          ...
          <div className="value-grid value-grid-3">
            <article className="value-panel">
              ...
              <p>
                Every clearance decision is anchored to the exact rule-set active at that moment, so
                your firm can explain past decisions even after policy changes.
              </p>
            </article>
            ...
            <article className="value-panel">
              ...
              <p>
                Matter exposure, deadlines, and policy dependencies are surfaced together so your team
                can act while risk is still controllable.
              </p>
            </article>
